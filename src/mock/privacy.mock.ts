  ...
  sections: [
    ...
    },
    {
      ...
      body: tx(
        ...
        'Мы собираем: идентификатор вашего аккаунта Telegram и публичный профиль (имя пользователя, отображаемое имя, аватар, язык и статус premium); адрес электронной почты и пароль, если вы решите их задать; вашу игровую активность (билеты, движки, турниры, стейки, статусы, покупки и рефералов); технические данные, такие как тип устройства, версия приложения, приблизительное местоположение по IP-адресу и диагностические логи; а также адрес вашего TON-кошелька, если вы его подключите. Мы не собираем ваш номер телефона, контакты и содержание ваших личных сообщений.',
