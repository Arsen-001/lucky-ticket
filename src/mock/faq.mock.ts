...
const articles: FaqArticle[] = [
  ...
  },
  {
    ...
    content: tx(
      'LC reaches real money through TON. You convert LC to TON at the fixed $0.00001/LC valuation (priced against the live TON→USD rate); the TON lands in your wallet and is withdrawn from there. Withdrawals handle TON only — LC is never withdrawn directly. A direct LC withdrawal (to fiat/USDT) is coming soon.',
