...
const articles: FaqArticle[] = [
  ...
  },
  {
    ...
    content: tx(
      ...
      'Уровень определяется накопленными AP: Bronze 0 AP (старт), Silver 500 AP (~2 недели), Gold 1 650 AP (~1.5 месяца), Platinum 5 900 AP (~4.5 месяца), Diamond 16 000 AP (~10 месяцев). Темп рассчитан на игрока, который каждый день собирает полную дневную базу — турниры ускоряют, пропуски замедляют.',
      'Ձեր մակարդակը որոշվում է կուտակված AP-ով՝ Bronze 0 AP (մեկնարկ), Silver 500 AP (~2 շաբաթ), Gold 1,650 AP (~1.5 ամիս), Platinum 5,900 AP (~4.5 ամիս), Diamond 16,000 AP (~10 ամիս)։ Տեմպը ենթադրում է խաղացող, ով ամեն օր հավաքում է ամբողջ օրական բազան. մրցաշարերն արագացնում են, բաց թողնված օրերը՝ դանդաղեցնում։',
      'Deine Stufe ergibt sich aus gesammelten AP: Bronze 0 AP (Start), Silber 500 AP (~2 Wochen), Gold 1.650 AP (~1,5 Monate), Platin 5.900 AP (~4,5 Monate), Diamond 16.000 AP (~10 Monate). Das Tempo geht von einem Spieler aus, der täglich die volle Tagesbasis sammelt — Turniere beschleunigen, verpasste Tage verlangsamen.'
    ),
  },
  {
    id: '7',
  ...
  },
  {
    ...
    content: tx(
      ...
      'Дневная база — это примерное количество AP, которое полностью активный игрок получает за день без трат. Она растёт с уровнем, потому что задания масштабируются: ~33 на Bronze, ~39 Silver, ~47 Gold, ~57 Platinum, ~70 Diamond. Разовые источники (подтверждение email, приглашения, турниры, стейки, покупки) начисляются сверх этой базы.',
      'Օրական բազան մոտավոր AP-ն է, որը լիովին ակտիվ խաղացողը վաստակում է ամեն օր առանց ծախսելու։ Այն աճում է մակարդակի հետ, քանի որ առաջադրանքները մասշտաբավորվում են՝ ~33 Bronze-ում, ~39 Silver, ~47 Gold, ~57 Platinum, ~70 Diamond։ Միանգամյա աղբյուրները (էլ. փոստի հաստատում, հրավերներ, մրցաշարեր, սթեյքեր, գնումներ) վաստակվում են այս բազայից վեր։',
      'Die tägliche Basis ist das ungefähre AP, das ein voll aktiver Spieler pro Tag ohne Geldausgabe verdient. Sie steigt mit der Stufe, da Aufgaben skalieren: ~33 bei Bronze, ~39 Silber, ~47 Gold, ~57 Platin, ~70 Diamond. Einmalige Quellen (E-Mail-Bestätigung, Einladungen, Turniere, Stakes, Käufe) kommen zusätzlich zu dieser Basis.'
    ),
  },
  {
    id: '9',
  ...
  },
  {
    ...
    content: tx(
      ...
      'Чипы собираются из осколков в инвентаре: тратите подходящие осколки, чтобы собрать новый чип этого типа и тира или поднять уровень уже собранного. Осколки приходят с турниров и из вкладки «Осколки» в Маркете. Готовые чипы и Chip Builder не продаются.',
      'Չիպերը հավաքվում են բեկորներից՝ գույքացանկում. ծախսում եք համապատասխան բեկորները նոր չիպ ստեղծելու համար կամ արդեն ունեցածի մակարդակը բարձրացնելու։ Բեկորները գալիս են մրցաշարերից և Շուկայի «Բեկորներ» ներդիրից։ Պատրաստի չիպերը և Chip Builder-ները չեն վաճառվում։',
      'Chips werden im Inventar aus Fragmenten zusammengesetzt: Du gibst passende Fragmente aus, um einen neuen Chip dieses Typs und dieser Stufe zu erstellen oder einen vorhandenen aufzuwerten. Fragmente kommen aus Turnieren und aus dem Markt-Tab „Fragmente“. Fertige Chips und Chip-Builder werden nicht verkauft.'
    ),
  },
  {
    id: '28',
  ...
  },
  {
    ...
    content: tx(
      'Lucky Player perks include +10% engine speed, +20% stake yield, doubled stake fee discounts, −10% market discount, +25% tournament LC reward, +50% tournament join AP, +10 ad views per day, 15% referral rate, higher ticket-send limits (and the ability to send Platinum/Diamond tickets), and bulk "Claim all" per tier.',
      'Привилегии Lucky Player: +10% к скорости движков, +20% к доходу стейков, удвоенные скидки на комиссию стейков, −10% скидка в Маркете, +25% к награде LC в турнирах, +50% к AP за вступление в турнир, +10 показов рекламы в день, реферальная ставка 15%, повышенные лимиты отправки билетов (и возможность отправлять Platinum/Diamond-билеты) и массовый «Забрать всё» по уровню.',
      'Lucky Player-ի առավելությունները ներառում են՝ +10% շարժիչի արագություն, +20% սթեյքի եկամուտ, կրկնապատկված սթեյքի վճարի զեղչեր, −10% շուկայի զեղչ, +25% մրցաշարի LC պարգև, +50% մրցաշարին միանալու AP, օրական +10 գովազդի դիտում, 15% ռեֆերալ դրույք, տոմս ուղարկելու բարձր սահմաններ (և Platinum/Diamond տոմսեր ուղարկելու հնարավորություն) և զանգվածային «Վերցնել բոլորը» ըստ մակարդակի։',
      'Lucky-Player-Vorteile umfassen +10% Engine-Geschwindigkeit, +20% Stake-Rendite, verdoppelte Stake-Gebührenrabatte, −10% Marktrabatt, +25% Turnier-LC-Belohnung, +50% Turnier-Beitritts-AP, +10 Werbe-Ansichten pro Tag, 15% Empfehlungsrate, höhere Ticket-Sendelimits (und die Möglichkeit, Platin/Diamond-Tickets zu senden) und das gebündelte „Alle einlösen" pro Stufe.'
    ),
  },
  {
    id: '49',
    ...
    content: tx(
      'VIP is permanent and leveled (up to level 20) — it never expires or decreases. Perks beat Lucky Player everywhere: +25% engine speed, +40% stake yield, −20% market discount, +50% tournament reward, +100% join AP, up to +30 ad views per day, 25% referral rate and dedicated support. The first unlock costs ~500 LS (or LC equivalent); each level upgrade is cheaper and grows per level. Paid with LC or Lucky Stars.',
      'VIP — постоянный и уровневый (до 20 уровня), не истекает и не снижается. Привилегии превосходят Lucky Player везде: +25% к скорости движков, +40% к доходу стейков, −20% скидка в Маркете, +50% к награде турниров, +100% к AP за вступление, до +30 показов рекламы в день, реферальная ставка 25% и выделенная поддержка. Первая разблокировка стоит ~500 LS (или эквивалент в LC); каждое повышение уровня дешевле и растёт с уровнем. Оплата в LC или Lucky Stars.',
      'VIP-ը մշտական է և մակարդակներով (մինչև 20 մակարդակ). երբեք չի ժամկետանց լինում կամ նվազում։ Առավելությունները գերազանցում են Lucky Player-ին ամենուր՝ +25% շարժիչի արագություն, +40% սթեյքի եկամուտ, −20% շուկայի զեղչ, +50% մրցաշարի պարգև, +100% միանալու AP, օրական մինչև +30 գովազդի դիտում, 25% ռեֆերալ դրույք և հատուկ աջակցություն։ Առաջին ապակողպումն արժե ~500 LS (կամ LC համարժեք). յուրաքանչյուր մակարդակի բարձրացում ավելի էժան է և աճում ըստ մակարդակի։ Վճարվում է LC-ով կամ Lucky Stars-ով։',
      'VIP ist permanent und gestuft (bis Stufe 20) — es verfällt oder sinkt nie. Vorteile übertreffen Lucky Player überall: +25% Engine-Geschwindigkeit, +40% Stake-Rendite, −20% Marktrabatt, +50% Turnierbelohnung, +100% Beitritts-AP, bis zu +30 Werbe-Ansichten pro Tag, 25% Empfehlungsrate und dedizierter Support. Die erste Freischaltung kostet ~500 LS (oder LC-Äquivalent); jedes Level-Upgrade ist günstiger und wächst pro Stufe. Bezahlt mit LC oder Lucky Stars.'
    ),
  },
  {
    id: '50',
