...
export const setAccessTokenCk = (token: string) => Cookies.set(accessTokenKey, token);
export const getAccessTokenCk = () => Cookies.get(accessTokenKey);
export const removeAccessTokenCk = () => Cookies.remove(accessTokenKey);

export const setRefreshTokenCk = (token: string) => Cookies.set(refreshTokenKey, token);
