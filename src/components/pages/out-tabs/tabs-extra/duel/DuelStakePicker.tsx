 ...
 * гаснут по остатку билетов — до тапа, а не после отказа сервера. Число стоит
 * над билетом и вплотную к нему: столбик — это фишка, а зазор между цифрой и
 * тем, чем платят, был не отступом, а пустотой внутри квадратной коробки
 * картинки (см. `DuelStakeAmount`).
 */
