 ...
 * ней.
 *
 * В списке двое разных: приведённые друзья и игроки с доски. Друзей у
 * большинства нет ни одного, и до второй половины списка экран был просто
 * пустым — играть можно было только с тем, кто подсядет сам через полминуты.
 * Отличить одних от других нельзя, и это осознанно: игрок зовёт игрока.
 *
