...
export function LeaderboardEmptyState() {
  ...
  return (
    <div className="card-outlined bg-purple-gradient flex flex-col items-center gap-3 rounded-2xl p-6 text-center">
      ...
      <Link
        href={routes.home}
        className="bg-pink-gradient mt-1 inline-flex items-center justify-center rounded-full px-4 py-2 text-xs font-extrabold uppercase tracking-wider text-white"
      >
        {t('play now')}
      </Link>
    </div>
