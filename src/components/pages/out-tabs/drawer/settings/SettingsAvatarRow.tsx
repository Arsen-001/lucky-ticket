  ...
  return (
    <>
      <button
        ...
        className="settings-card settings-card--purple flex w-full items-center justify-between gap-4 rounded-xl px-3.5 py-3 text-start transition-all active:scale-99 active:opacity-90"
      >
