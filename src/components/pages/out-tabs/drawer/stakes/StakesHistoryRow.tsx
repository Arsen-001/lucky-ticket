    ...
    >
      ...
      <div className="relative flex flex-col items-end gap-1">
        ...
        <Link
          ...
          className="border-electric-pink/30 bg-electric-pink/10 text-electric-pink hover:bg-electric-pink/20 inline-flex items-center gap-0.5 rounded-full border px-1.5 py-0.5 text-[9px] font-extrabold uppercase tracking-wider transition-colors"
        >
