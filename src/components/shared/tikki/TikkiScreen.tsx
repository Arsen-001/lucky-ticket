  ...
  return (
    <div className={twMerge('flex flex-available flex-col px-[14px] pt-2.5', className)}>
      ...
      {/* Персонаж занимает всё, что осталось между счётом и нижним рядом. Чипы
          ...
          `tikki-stage` — сцена меряет себя сама: облако над головой
          показывается только там, где ему есть место, а персонаж ростом не
          выше сцены (контейнерные единицы, см. `TikkiHero`). Сцена берёт всё,
          что осталось от остальных рядов, поэтому на 390×844 она 421–497 px и
          персонаж стоит в свой рост, а на 360×740 — 317, и он ужимается. До
          05.09.2026 пол стоял на росте персонажа (356), и на 360×740 экран
          был длиннее прокрутки на 39 px: лента и пилюли под сгибом. Пол 216 —
      ...
      <div className="tikki-stage relative flex min-h-[216px] flex-available items-end justify-center">
        <TikkiHero
          ...
          // Оттуда и его размер: он крупный потому, что уходит ЗА них. Когда
          // сцена ниже его роста и он ужат, ступают на столько же меньше:
          // 28/356 = 7,865% высоты сцены, не больше макетных 28.
          className="translate-y-[min(28px,7.865cqh)]"
        />
