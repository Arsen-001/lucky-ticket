 ...
 * 20% is shared equally among all participants of the charged tournament
 * instance; the remaining 80% goes to the top-3 podium, itself split 50/30/20.
 * → participants 20%, 1st 40%, 2nd 24%, 3rd 16%.
 */
